...
export default async function HomeClient(){
  ...
  return <main>
    ...
    <footer><p className="footer-mark">SIMSIM_ENT.</p><div className="footer-info"><p>심심엔터테인먼트</p><p>개인정보보호 책임자 : 림딩웬</p><a href="mailto:contact@simsiment.com">contact@simsiment.com</a></div><small>© 2026 SIMSIM_ENT. ALL RIGHTS RESERVED.</small></footer>
  </main>
}
